...
process that goes into building language models. Overall, this project helped me build an intuition of what jargon like 
parameter count and context length exactly refer to within the architecture of a language model.
...
manifest as implementation decisions we directly follow in our code. Fascinating!
...
Second, after pre-training: OpenAI only has a big stupid document autocompleter, it would blabber in many languages and
...
Trained 25m parameter model on A100 from [lightning.ai](https://lightning.ai) with:
